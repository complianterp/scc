package com.company.scc.SAPData;
...
public class ConnectivityRFCExample extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            // access the RFC Destination "ABAP_AZURE"
            ...
            responseWriter.println("<h1>Executed STFC_CONNECTION in system ABAP_AZURE</h1>");
        ...
        catch (JCoException e)
        {
            response.addHeader("Content-type", "text/html");
            responseWriter.println("<html><body>");
            responseWriter.println("<h1>Exception occurred while executing STFC_CONNECTION in system ABAP_AZURE</h1>");
